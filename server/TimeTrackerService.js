...
class TimeTrackerService {
    ...
    start() {
        ...
        console.log('Starting TimeTrackerService...');
        ...
        this.isRunning = true;
        console.log(`TimeTrackerService started with ${this.minuteHandlers.size} minute handlers and ${this.tenMinuteHandlers.size} ten-minute handlers`);
    }
    ...
    stop() {
        ...
        this.isRunning = false;
        console.log('TimeTrackerService stopped');
    }
    ...
    registerMinuteHandler(name, handler) {
        ...
        console.log(`Registered minute handler: ${name}`);
    }
    ...
    registerTenMinuteHandler(name, handler) {
        ...
        console.log(`Registered ten-minute handler: ${name}`);
    }
    ...
    unregisterMinuteHandler(name) {
        if (this.minuteHandlers.delete(name)) {
            console.log(`Unregistered minute handler: ${name}`);
            return true;
        }
        return false;
    }
    ...
    unregisterTenMinuteHandler(name) {
        if (this.tenMinuteHandlers.delete(name)) {
            console.log(`Unregistered ten-minute handler: ${name}`);
            return true;
        }
        return false;
    }
