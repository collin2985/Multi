...
const CONFIG = {
    ...
    CONSTRUCTION: {
        ...
        MATERIALS: {
            ...
            boat: { oakplank: 1 },
            market: { oakplank: 1 },
            garden: { chiseledlimestone: 1, vegetableseeds: 1, appleseed: 1 },
            road: { chiseledlimestone: 1 },
            dock: { oakplank: 1 },
            fisherman: { oakplank: 1 },
            tileworks: { oakplank: 1 },
            ironworks: { oakplank: 1 },
            blacksmith: { oakplank: 1 },
            bakery: { oakplank: 1 },
            gardener: { oakplank: 1 },
            miner: { oakplank: 1 },
            woodcutter: { oakplank: 1 },
            stonemason: { oakplank: 1 },
            horse: { vegetables: 1 },
            cart: { oakplank: 1 },
            artillery: { oakplank: 1 },
