...
const CONFIG = {
    ...
    MARKET: {
        ...
        ALL_ITEMS: [
            ...
            'rope',
            // Seeds
            'vegetableseeds', 'appleseed', 'pineseed', 'firseed',
            // Food
            'apple', 'vegetables', 'roastedvegetables', 'mushroom',
    ...
    SHIP_TRADING: {
        ...
        BUY_MATERIALS: [
            'limestone', 'sandstone', 'granite', 'clay', 'iron',
            'chiseledlimestone', 'chiseledsandstone', 'chiseledgranite', 'tile',
            'oakplank', 'pineplank', 'firplank', 'cypressplank', 'appleplank',
            'oakfirewood', 'pinefirewood', 'firfirewood', 'cypressfirewood', 'applefirewood',
            'rope'
        ...
        PRICES: {
            ...
            limestone: 2, sandstone: 2, granite: 2, clay: 2, iron: 2,
            chiseledlimestone: 4, chiseledsandstone: 4, chiseledgranite: 4, tile: 8,
            oakplank: 3, pineplank: 3, firplank: 3, cypressplank: 3, appleplank: 3,
            oakfirewood: 3, pinefirewood: 3, firfirewood: 3, cypressfirewood: 3, applefirewood: 3,
            rope: 5,
