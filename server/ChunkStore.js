...
class ChunkManager {
    ...
    async initialize() {
        if (db.isOnlineMode) {
            ...
            console.log('ChunkManager: Online mode - database required');
            ...
            console.log('ChunkManager: Local mode - using JSON files');
            this.dbReady = false;
        ...
        if (this.dbReady) {
            ...
            try {
                ...
                if (result.rows.length > 0) {
                    ...
                    console.log(`ChunkManager: Loaded server tick from database: ${tick}`);
            ...
            try {
                if (fs.existsSync(SERVER_STATE_FILE)) {
                    ...
                    console.log(`ChunkManager: Loaded server tick from file: ${data.tick}`);
