...
class DatabaseManager {
    constructor() {
        ...
        // Online mode = DATABASE_URL is set (Render provides this)
        this.isOnlineMode = !!process.env.DATABASE_URL;
    }
    ...
    async connectWithRetry() {
        ...
        for (let attempt = 0; attempt < retryDelays.length; attempt++) {
            ...
            if (delay > 0) {
                console.log(`Database connection retry in ${delay / 1000}s... (attempt ${attempt + 1}/${retryDelays.length})`);
    ...
    async initializeSchema() {
        ...
        try {
            ...
            console.log('✓ Database schema initialized (chunks + auth + spawn + audit tables)');
        } catch (error) {
