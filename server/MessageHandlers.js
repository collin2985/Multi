...
class MessageHandlers {
    constructor(chunkManager, messageRouter, clients, cookingSystem = null, tileworksSystem = null, ironworksSystem = null, blacksmithSystem = null, bakerySystem = null) {
    ...
    async handlePlaceConstructionSite(payload) {
        try {
            ...
            //     requiredMaterials = { 'oakplank': 1 };
                ...
                requiredMaterials = { 'oakplank': 1 };  // TEST: was { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 }
            } else if (targetStructure === 'tileworks') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
            } else if (targetStructure === 'ironworks') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
            } else if (targetStructure === 'blacksmith') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
            } else if (targetStructure === 'bakery') {
                requiredMaterials = { 'oakplank': 1 };  // TEST: was { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 }
            } else if (targetStructure === 'gardener') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
            } else if (targetStructure === 'miner') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
            } else if (targetStructure === 'woodcutter') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
            } else if (targetStructure === 'stonemason') {
                requiredMaterials = { 'oakplank': 1, 'chiseledlimestone': 1, 'tile': 1 };
    ...
    async handleBuildConstruction(payload) {
        try {
            ...
            // For houses, gardens, campfires, tileworks, ironworks, blacksmith, bakery, and markets, initialize inventory (like crates)
     ...
     * @param {WebSocket} ws
     * @param {object} payload - { npcType, bakeryId, marketId, chunkId, itemType, count }
     */
     ...
     * @param {WebSocket} ws
     * @param {object} payload - { npcType, bakeryId, marketId, chunkId, items }
     */
