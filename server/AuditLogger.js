...
class AuditLogger {
    constructor(db, dbReady) {
        ...
        console.log(`[AuditLogger] Initialized (mode: ${dbReady ? 'database' : 'file'})`);
    }
     ...
     */
    logStructureAdd(objType, objId, chunkX, chunkZ, actorId, actorAccount, username) {
        this.log({
     ...
     */
    logStructureRemove(objType, objId, chunkX, chunkZ, actorId, actorAccount, ownerId, username) {
        this.log({
     ...
     */
    logInventoryOpen(objType, objId, chunkX, chunkZ, actorId, actorAccount, ownerId, inventory, username) {
        this.log({
     ...
     */
    logInventorySave(objType, objId, chunkX, chunkZ, actorId, actorAccount, ownerId, inventory, username) {
        this.log({
     ...
     * Log market purchase
     */
    logMarketBuy(objId, chunkX, chunkZ, actorId, actorAccount, ownerId, itemType, quality, durability, username) {
        this.log({
     ...
     * Log market sale
     */
    logMarketSell(objId, chunkX, chunkZ, actorId, actorAccount, ownerId, itemType, quality, durability, username) {
        this.log({
     ...
     */
    logConnect(actorId, actorAccount, ipAddress, username) {
        this.log({
     ...
     */
    logDisconnect(actorId, actorAccount, lastChunkX, lastChunkZ, username) {
        this.log({
     ...
     */
    logChunkEnter(chunkX, chunkZ, actorId, actorAccount, prevChunkX, prevChunkZ, username) {
        this.log({
            ...
            actor_account: actorAccount || null,
            actor_name: username || null,
            data: prevChunkX != null ? { from_x: prevChunkX, from_z: prevChunkZ } : null
        });
    }
     ...
     */
    logHarvest(objType, objId, chunkX, chunkZ, actorId, actorAccount, remainingResources, username) {
        this.log({
