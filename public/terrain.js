        ...
        this.terrainMaterial = new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    vec3 dirtColor = texture2D(uDirt, vPosition.xz * 0.1).rgb;
                    vec3 grassColor = texture2D(uGrass, vPosition.xz * 0.1).rgb;
                    vec3 rockColor = texture2D(uRock, vPosition.xz * 0.1).rgb;
                    vec3 snowColor = texture2D(uSnow, vPosition.xz * 0.1).rgb;
            ...
            self.onmessage = function(e) {
                if (e.data.type === 'calculateHeightBatch') {
                    ...
                    const results = points.map(point => {
                        const height = perlin(point.x * 0.05, 0, point.z * 0.05) * 10;
