...
export const CONFIG = {
    ...
    CART_PHYSICS: {
        ...
        ROAD_SPEED_MULTIPLIER: 2.0,           // TEST: Double speed on roads (was 1.6)
    ...
    ARTILLERY_PHYSICS: {
        ...
        // Road bonus
        ROAD_SPEED_MULTIPLIER: 2.0,           // TEST: Double speed on roads (was 1.4)
    ...
    CONSTRUCTION: {
        ...
        GRID_DIMENSIONS: {
            ...
            wall: { width: 1.0, depth: 0.1, height: 2.0 },  // Simple wall segment
            ...
            artillery: { radius: 0.4, height: 2.0 },  // Cylindrical like cart
        ...
        MATERIALS: {
            ...
            market: {
                oakplank: 1  // TEST: was oakplank: 1, chiseledlimestone: 1, tile: 1
            },
            garden: {
                chiseledlimestone: 1,
                vegetableseeds: 1,
            ...
            artillery: {
                oakplank: 1   // TEST: was parts: 1, oakplank: 1
            },
            wall: {
    ...
    QUALITY: {
        HIGH: {
            ...
            FOG_COLOR: 0x99bbdd,          // Must match CONFIG.RENDERING.FOG_COLOR
