...
export class DeerController extends BaseAIController {
    ...
    handleStateMessage(data) {
        const { treeId, position, rotation, state, authorityId, authorityTerm, deathTick, wanderDirection, fleeDirection } = data;

        const entity = this.entities.get(treeId);
        if (!entity) {
            this.pendingStates.set(treeId, { position, rotation, state, authorityId, authorityTerm, deathTick, wanderDirection, fleeDirection });
            return;
        }
