...
export class NameTagManager {
     ...
     */
    _drawToCanvas(ctx, canvas, text, isDead) {
        ...
        // Draw white (or red if dead) fill
        ctx.fillStyle = isDead ? '#ff4444' : '#ffffff';
    ...
    _updateSpriteText(tagData, displayName, isDead) {
        ...
        this._drawToCanvas(tagData.ctx, tagData.canvas, displayName, isDead);
