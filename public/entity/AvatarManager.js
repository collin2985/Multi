            ...
            if (avatar.userData.mixer && shouldUpdateAnimation) {
                ...
                if (peer?.harvestState) {
                    ...
                    if (shouldUpdateCombat && game) {
                        ...
                        // Check bears via BearController
                        if (!inCombatStance && game.bearController) {
                            const nearbyBears = game.bearController.getLivingBearNear(avatarX, avatarZ, combatDistance);
