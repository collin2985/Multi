...
export class BillboardSystem {
    ...
    updateBillboards(cameraPosition) {
        ...
        // Structure LOD thresholds
        // Billboard: fades in 60-70, solid at 70
        // Model: pops in at 70, pops out at 75
        const structBillboardStart = 60;
        const structBillboardEnd = 70;   // Billboard fully visible at 70
        const structBillboardStartSq = structBillboardStart * structBillboardStart;  // 3600
        const structBillboardEndSq = structBillboardEnd * structBillboardEnd;        // 4900
        const structSkipNearSq = structBillboardStartSq * 0.9;     // Skip threshold (~57 units)
        const structSkipFarSq = structBillboardEndSq * 1.1;        // Skip threshold (~73 units)
