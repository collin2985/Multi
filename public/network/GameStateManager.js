...
export class GameStateManager extends EventEmitter {
    ...
    handleArtilleryUnloadedShip(payload, fromPeer, peerData) {
        const { artilleryId, position, rotation, destroyed } = payload;
        ...
        if (artilleryData?.mesh) {
            ...
            if (destroyed || artillery.userData?.isPeerArtillery) {
        ...
        if (destroyed && artilleryData?.hasMilitia && this.game?.banditController) {
