...
export class StructureModelSystem {
    constructor(scene) {
        ...
        // LOD thresholds: 50-60 model fades out (billboard is 40-50)
        this.lodStartDistance = 50;   // Model starts fading at 50
        this.lodEndDistance = CONFIG.LOD?.STRUCTURE_LOD_END || 60;  // Model hidden at 60
