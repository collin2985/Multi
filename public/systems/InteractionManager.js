...
export class InteractionManager {
    ...
    checkProximityToObjects() {
        ...
        const structureTypes = ['crate', 'tent', 'house', 'garden', 'market', 'outpost', 'ship', 'dock', 'campfire', 'tileworks', 'ironworks', 'blacksmith', 'bakery', 'gardener', 'miner', 'woodcutter', 'stonemason', 'bearden', 'artillery'];
        const mobileEntityTypes = ['boat', 'horse'];  // Types that can be piloted/ridden
        const towableEntityTypes = ['cart', 'artillery'];  // Types that can be towed (artillery is horse-only)
