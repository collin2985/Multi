...
export class InteractionManager {
    constructor(game) {
        ...
        this.structureTypes = new Set(['crate', 'tent', 'house', 'garden', 'market', 'outpost', 'ship', 'dock', 'campfire', 'tileworks', 'ironworks', 'blacksmith', 'bakery', 'gardener', 'fisherman', 'miner', 'woodcutter', 'stonemason', 'bearden', 'artillery']);
        this.mobileEntityTypes = new Set(['boat', 'horse']);
