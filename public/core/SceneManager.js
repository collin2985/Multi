    ...
    setupSkybox() {
        ...
        if (CONFIG.SKYBOX.ENABLED) {
            switch (CONFIG.SKYBOX.TYPE) {
                ...
                case 'sphere':
                    this.skyboxManager.loadSphereSkybox(
                        CONFIG.SKYBOX.SPHERE.TEXTURE_PATH,
                        CONFIG.SKYBOX.SPHERE.RADIUS
                    ).catch(err => {
                        console.warn('Failed to load sphere skybox, falling back to gradient:', err);
                        this.skyboxManager.createGradientSkybox({
                            top: CONFIG.SKYBOX.GRADIENT.TOP,
                            bottom: CONFIG.SKYBOX.GRADIENT.BOTTOM
                        });
                ...
                case 'cylinder':
                    this.skyboxManager.loadCylindricalSkybox(
                        ...
                        console.warn('Failed to load cylindrical skybox, falling back to gradient:', err);
                        this.skyboxManager.createGradientSkybox({
                            top: CONFIG.SKYBOX.GRADIENT.TOP,
                            bottom: CONFIG.SKYBOX.GRADIENT.BOTTOM
                        });
                ...
                case 'cubemap':
                    this.skyboxManager.loadCubeMapSkybox(
                        CONFIG.SKYBOX.CUBEMAP.TEXTURE_PATHS
                    ).catch(err => {
                        console.warn('Failed to load cubemap skybox, falling back to gradient:', err);
                        this.skyboxManager.createGradientSkybox({
                            top: CONFIG.SKYBOX.GRADIENT.TOP,
                            bottom: CONFIG.SKYBOX.GRADIENT.BOTTOM
                        });
