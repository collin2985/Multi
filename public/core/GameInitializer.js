...
export class GameInitializer {
    ...
    setupRenderers() {
        ...
        // Connect artillery manning state (blocks WASD movement while manning)
        this.game.playerController.artilleryManningState = this.game.gameState.artilleryManningState;
    ...
    async finalizeNetworking() {
        console.log('[GameInitializer] finalizeNetworking called, navigationManager:', !!this.game.navigationManager);
        ...
        if (this.game.navigationManager) {
            ...
            console.log('[GameInitializer] Navigation worker initialized');
        }
            ...
            onShoot: (tentId, targetId, didHit, banditPos) => {
                ...
                if (didHit && isLocalPlayer) {
                    ...
                    if (this.game.loadingScreen?.isActive) {
                        console.log('[onShoot] PLAYER HIT but loading screen active - ignoring');
                        return;
                    }
                    // Ignore damage during spawn immunity period (60 seconds after spawn)
                    if (this.game.spawnImmunityEndTime && Date.now() < this.game.spawnImmunityEndTime) {
                        console.log('[onShoot] PLAYER HIT but spawn immunity active - ignoring');
                        return;
                    }
        ...
        this.game.brownBearController.initialize({
            ...
            onAttack: (denId, targetId, bearPos) => {
                ...
                if (isLocalPlayer) {
                    ...
                    // Ignore damage during spawn immunity period (60 seconds after spawn)
                    if (this.game.spawnImmunityEndTime && Date.now() < this.game.spawnImmunityEndTime) {
                        console.log('[onAttack] Bear attack ignored - spawn immunity active');
                        return;
                    }
                    this.game.deathReason = 'Killed by brown bear';
                    this.game.playerCombat.die();
                }
            },
    ...
    initializeBakerController() {
        ...
        this.game.bakerController.initialize({
            ...
            findPathAsync: async (from, to) => {
                if (!this.game.navigationManager) return null;
                return this.game.navigationManager.findPathAsync(from.x, from.z, to.x, to.z, { ignoreSlopes: true });
            },
        ...
        console.log('[GameInitializer] BakerController initialized');
    }
    ...
    initializeGardenerController() {
        ...
        console.log('[GameInitializer] GardenerController initialized');
    }
    ...
    initializeWoodcutterController() {
        ...
        console.log('[GameInitializer] WoodcutterController initialized');
    }
    ...
    initializeMinerController() {
        ...
        console.log('[GameInitializer] MinerController initialized');
    }
    ...
    initializeStoneMasonController() {
        ...
        console.log('[GameInitializer] StoneMasonController initialized');
    }
    ...
    initializeIronWorkerController() {
        ...
        console.log('[GameInitializer] IronWorkerController initialized');
    }
    ...
    initializeTileWorkerController() {
        ...
        console.log('[GameInitializer] TileWorkerController initialized');
    }
    ...
    initializeBlacksmithController() {
        ...
        console.log('[GameInitializer] BlacksmithController initialized');
    }
    ...
    initializeFishermanController() {
        ...
        console.log('[GameInitializer] FishermanController initialized');
    }
