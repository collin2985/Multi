...
export class GameState {
    constructor() {
        ...
        this.nearestBearCorpse = null; // {chunkKey, position, distance, chunkX, chunkZ} for bear harvesting
        ...
        this.roads = new Map(); // Key: chunkKey, Value: Array of { id, x, z, radius } for road persistence
