...
// --- 2. Depth-Based Color Variation (FIXED for [-1.0, 1.0]) ---
        // depth: 1.0=Shallow (vDepth=1.0), 0.0=Deep (vDepth=-1.0)
        float depth = smoothstep(-1.0, 1.0, vDepth); 
        
        // Color transition (mixes in deep_color when depth is 0.0)
        vec3 waterBaseColor = mix(u_shallow_color, u_deep_color, 1.0 - depth);
...
        
        // Caustics strongest when depth=1.0 (Shallow)
...
            u_deep_color: { value: new THREE.Color(0x001f5f) },    // Darker ocean blue
            u_foam_color: { value: new THREE.Color(0xffffff) },    // White foam (fallback)
            u_wave_height: { value: 0.2 },                        // Smaller waves (0.12 meters)
            u_wave_frequency: { value: 0.01 },                    // Tighter waves
...
            u_normal_scale: { value: 0.05 },                      // Subtler normal mapping
