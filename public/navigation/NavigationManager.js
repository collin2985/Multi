...
export class NavigationManager {
    ...
    async initializeWorker() {
        try {
            console.log('[NavigationManager] Initializing worker...');
            const { initializeNavigationWorker } = await import('./NavigationWorkerClient.js');
            this.workerClient = await initializeNavigationWorker();
            console.log('[NavigationManager] Worker initialized, registering', this.chunkMaps.size, 'chunks');
            ...
            console.log('[NavigationManager] Worker ready');
        } catch (e) {
            console.warn('[NavigationManager] Worker init failed, using sync:', e);
        }
    }
