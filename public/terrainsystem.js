...
export class TerrainGenerator {
    ...
    addLeveledArea(centerX, centerZ, width, depth, targetHeight, rotation, options = {}) {
        ...
        // Store cos/sin of rotation; inverse transform applied in getLeveledHeight
        ...
        const newArea = {
            ...
            depth,
            rotation, // Radians
            // Store options for getLeveledHeight
    ...
    getLeveledHeight(worldX, worldZ, proceduralHeight) {
        ...
        for (const area of this.leveledAreas) {
            ...
            // Rotate to structure's local space (inverse rotation: R(-θ) = R(θ)^T)
