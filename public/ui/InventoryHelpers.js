...
export function getItemSize(itemType) {
    ...
    const metalMaterials = ['iron']; // 1x1

    // Define food types
    const foodItems = ['apple', 'vegetables', 'fish', 'cookedfish', 'cookedmeat', 'roastedvegetables', 'mushroom', 'rawmeat']; // 1x1

    // Define seed types
    const seedItems = ['pineseed', 'appleseed', 'firseed', 'vegetableseeds']; // 1x1

    // Define ammo types
    const ammoItems = ['ammo']; // 1x1
