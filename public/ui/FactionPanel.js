...
export class FactionPanel {
        ...
        if (this.networkManager) {
            this.networkManager.on('change_faction_response', (data) => {
                if (data.success) {
                    ...
                    this.gameState.home = null; // Clear home on client
                    this.hide(); // Hide faction panel
            ...
            ">
                ...
                ${currentFaction !== null ? `
                    <div style="color: #D4C4A8; font-size: 13px; margin-top: 8px;">
                        Territory: Z ${FACTION_ZONES[currentFaction].minZ} to ${FACTION_ZONES[currentFaction].maxZ}
                    </div>
                ` : `
                    <div style="color: #D4C4A8; font-size: 13px; margin-top: 8px;">
    ...
    async handleChangeFaction(newFactionId) {
        ...
        const confirmed = await ui.showConfirmDialog(
            ...
            'WARNING: This will:\n' +
            '- Kill you and respawn in new territory\n' +
