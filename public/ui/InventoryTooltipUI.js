...
export class InventoryTooltipUI {
    ...
    showTooltip(event, item, anchorElement = null) {
        ...
        if (toolTypes.includes(item.type)) {
            ...
            tipEl.textContent = 'Tip: Drag Chisel on top to create chiseled limestone.';
            tipSection.style.display = '';
            ...
            tipEl.textContent = 'Tip: Drag onto another Rope to create a fishing net.';
            tipSection.style.display = '';
    ...
    showCombineTooltip(draggedItem, targetItem, anchorElement, craftingSystem) {
        ...
        if (targetItem) {
            ...
            // Check for chisel + stone combination
            if (draggedType === 'chisel') {
