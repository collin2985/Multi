...
export class LoadingScreen {
    ...
    hide() {
        ...
        // Set spawn immunity for 60 seconds after loading completes
        if (this.game) {
            this.game.spawnImmunityEndTime = Date.now() + 60000;
            console.log('[LoadingScreen] Spawn immunity active for 60 seconds');
        }
