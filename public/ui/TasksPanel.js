...
export class TasksPanel {
    constructor(gameState, networkManager) {
        ...
        this.tasks = [
            ...
            { id: 3, title: 'Gather 4 pieces of vines', description: 'Gather 4 vines total. If your backpack is full, drag unwanted items (stone, extra planks) outside it to discard.' },
            ...
            { id: 9, title: 'Mine limestone', description: 'Keep tools in your backpack and you will get options at the top of the screen to gather resources when in range. Find grey rocks in the world, stand next to them, and click "Mine Limestone". Limestone is useful for building and can be combined with rope to make an improvised tool in a pinch.' },
            ...
            { id: 27, title: 'Build a market', description: 'Build a market within 20 units of your dock. Markets supply tools and weapons when stocked with materials.' },
            { id: 28, title: 'Enable merchant ships', description: 'Go next to the market and hit the Market button. Click "Enable Merchant Ships" to allow trade ships to visit your dock.' },
            { id: 29, title: 'Talk to the merchant', description: 'Ships arrive every 30 minutes. In the meantime, gather resources and store them in your tent. When a ship docks, a merchant walks onto the pier. Stand near them and click "Talk to Merchant". Stock the market with 20 items of the same material to trade for tools/weapons.' }
        ];
    ...
    onItemAdded(itemType, count) {
        ...
        if (type === 'vines') {
            this.completeTask(1);
            // Track total vines gathered (not just current inventory count)
            this.totalVinesGathered++;
            // Task 3: Gather 4 pieces of vines (cumulative, not current inventory)
            if (this.totalVinesGathered >= 4) {
                this.completeTask(3);
            }
            // Task 16: Gather 2 vines (for tent rope) - use current inventory count
            if (count >= 2) {
