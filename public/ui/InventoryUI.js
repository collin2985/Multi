...
export class InventoryUI {
    ...
    getItemUnderCursor(cursorX, cursorY, draggingItem) {
        ...
        const combinableItems = ['vines', 'Rvines', 'rope', 'Rrope', 'limestone', 'Rlimestone'];
    ...
    _getCombineTarget(item) {
        ...
        if (!['vines', 'rope', 'limestone'].includes(itemType)) return null;
        try {
            const targetItem = this.getItemUnderCursor(this.inventoryMouseX, this.inventoryMouseY, item);
    ...
    onMouseUp(event) {
        ...
        try {
            ...
            const itemType = item.type.replace('R', '');
            if (source === 'backpack' && ['vines', 'rope', 'limestone'].includes(itemType) && this.combineTarget) {
