...
export class AIEnemy {
    ...
    setupModel() {
        ...
        // Setup materials
        const BANDIT_SHIRT_COLOR = 0x3D2314; // Dark brown shirt color for bandits
        aiEnemyMesh.traverse((child) => {
            if (child.isMesh || child.isSkinnedMesh) {
                ...
                // Color the shirt dark brown (Cube001_3 is the shirt mesh)
                if (child.name === 'Cube001_3' && child.material) {
                    child.material = child.material.clone();
                    child.material.color.setHex(BANDIT_SHIRT_COLOR);
                }
            }
        });
        ...
        if (this.animationMixer) {
            ...
            if (isShootPlaying) {
                ...
                if (this.moving) {
                    ...
                    this.animationMixer.update((deltaTime / 1000) * this.speedMultiplier);
                } else {
