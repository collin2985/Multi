...
export class TreeGUI {
    ...
    setupGUI() {
        // GUI disabled - uncomment to enable debug controls
        // try {
        ...
        //     console.log('[TreeGUI] GUI created successfully');
        // } catch (e) {
    ...
    enableRockGUI() {
        if (this.gui) {
            console.log('[TreeGUI] GUI already active');
            return;
        }
        ...
        try {
            ...
            this.gui.domElement.style.left = '10px';
            this.gui.domElement.style.zIndex = '9999';
            console.log('[TreeGUI] Rock GUI created successfully');
        } catch (e) {
            console.error('[TreeGUI] Failed to create GUI:', e);
            return;
        }
    ...
    enableStructureGUI() {
        if (this.gui) {
            console.log('[TreeGUI] GUI already active - adding structure controls');
        } else {
            try {
                ...
                this.gui.domElement.style.left = '10px';
                this.gui.domElement.style.zIndex = '9999';
                console.log('[TreeGUI] Structure GUI created successfully');
            } catch (e) {
                console.error('[TreeGUI] Failed to create GUI:', e);
                return;
            }
    ...
    setupStructureBillboardControls() {
        ...
        const structureTypes = ['tent', 'outpost', 'campfire', 'horse'];
        ...
        for (const structType of structureTypes) {
            ...
            const folder = structuresFolder.addFolder(structType.charAt(0).toUpperCase() + structType.slice(1));
