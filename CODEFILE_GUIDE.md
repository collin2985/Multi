...
| **Combat Effects** | `public/effects/MuzzleFlash.js`, `public/effects/DirtKickup.js`, `public/effects/GunSmoke.js` |
...
- **Priority:** bandits (3) > brownbears (2) > deer (1)
...
## Client: Effects (public/effects/) - ~410 lines
...
### GunSmoke.js (~130 lines)
White smoke wisp that rises from gun barrel after firing. One-shot effect, auto-disposes after ~2 seconds.
- **Exports:** `GunSmoke`
- **Used by:** `EffectManager.js`
