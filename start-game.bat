...
if defined WT_SESSION (
    ...
    wt -w 0 nt -d "%cd%" --title "Web Server" powershell -NoExit -Command "http-server . -p 8000"
    wt -w 0 nt -d "C:\Users\colli\Desktop\test horses\horses" --title "Claude" powershell -NoExit -Command "& 'C:\Users\colli\.local\bin\claude.exe'"
) else (
    ...
    if %ERRORLEVEL% EQU 0 (
        ...
        wt -w new -d "%cd%" --title "Game Server" powershell -NoExit -Command "node server.js" ; ^
           nt -d "%cd%" --title "Web Server" powershell -NoExit -Command "http-server . -p 8000" ; ^
           nt -d "C:\Users\colli\Desktop\test horses\horses" --title "Claude" powershell -NoExit -Command "& 'C:\Users\colli\.local\bin\claude.exe'"
    ) else (
