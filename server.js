...
async function initializeServer() {
    ...
    const ironworksSystem = new IronworksSystem(chunkManager, messageRouter, null);
    const blacksmithSystem = new BlacksmithSystem(chunkManager, messageRouter, null);
    const bakerySystem = new BakerySystem(chunkManager, messageRouter, null);
    const messageHandlers = new MessageHandlers(chunkManager, messageRouter, clients, cookingSystem, tileworksSystem, ironworksSystem, blacksmithSystem, bakerySystem);
    ...
    ironworksSystem.timeTrackerService = messageHandlers.timeTracker;
    blacksmithSystem.timeTrackerService = messageHandlers.timeTracker;
    bakerySystem.timeTrackerService = messageHandlers.timeTracker;
